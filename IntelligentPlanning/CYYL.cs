namespace IntelligentPlanning
{
    ...
    public class CYYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.CYYLXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.CYYLXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLLD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLSE15F)
            {
                return "205";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.CYYLXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLDLD30M)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.CYYLHGSSC)
            {
                return "191";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CYYLNY15C)
            {
                return "206";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.CYYLXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLLD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLSE15F)
            {
                str = "SHOUERSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLDLD30M)
            {
                str = "TG30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CYYLHGSSC)
            {
                str = "HGSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CYYLNY15C)
            {
                str = "NEWYOSSC";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("彩云娱乐");
        }

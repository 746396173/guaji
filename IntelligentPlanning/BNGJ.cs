namespace IntelligentPlanning
{
    ...
    public class BNGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BNFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.BN5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BNTXFFC)
            {
                return "30001";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("博牛");
        }

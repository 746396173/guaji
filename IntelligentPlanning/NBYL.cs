namespace IntelligentPlanning
{
    ...
    public class NBYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.NBTGSSC)
            {
                if (pIsBets)
                {
            ...
            if ((((pType == ConfigurationStatus.LotteryType.GD11X5) || (pType == ConfigurationStatus.LotteryType.JX11X5)) || (pType == ConfigurationStatus.LotteryType.SH11X5)) && pIsBets)
            {
                str = str.Replace("-0", "-");
            }
            return str;
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.NBRBSSC)
            {
                return "23";
            }
            if (pType == ConfigurationStatus.LotteryType.NBFFC)
            {
                return "11";
            }
            if (pType == ConfigurationStatus.LotteryType.NB5FC)
            {
                return "4";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WHXJPSSC)
            {
                return "34";
            }
            if (pType == ConfigurationStatus.LotteryType.JDSSC)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.HG1FC)
            {
                return "45";
            }
            if (pType == ConfigurationStatus.LotteryType.JBEITG30)
            {
                return "46";
            }

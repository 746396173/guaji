namespace IntelligentPlanning
{
    ...
    public class HSGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HSFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.HS5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HSDJSSC)
            {
                return "10022";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HSQQFFC)
            {
                return "10001";
            }
            if (pType == ConfigurationStatus.LotteryType.HSSE15F)
            {
                return "10021";
            }

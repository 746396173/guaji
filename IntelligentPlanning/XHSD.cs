namespace IntelligentPlanning
{
    ...
    public class XHSD : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XHSDFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.XHSD5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XHSDFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("大时代");
        }

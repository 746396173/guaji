namespace IntelligentPlanning
{
    ...
    public class FEIC : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.FEICXJP2FC)
            {
                return "32";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC3FC)
            {
                return "17";
            }
            if (pType == ConfigurationStatus.LotteryType.FEICSLFK5FC)
            {
                return "18";
            }
            if (pType == ConfigurationStatus.LotteryType.FEICFFC)
            {
                return "13";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.FEICDJSSC)
            {
                return "31";
            }
            if (pType == ConfigurationStatus.LotteryType.FEICHGSSC)
            {
                return "33";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC30M)
            {
                return "48";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC45M)
            {
                return "49";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.FEICFF11X5)
            {
                return "14";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC2F11X5)
            {
                return "34";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC3F11X5)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC5F11X5)
            {
                return "36";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.FEICFFPK10)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC2FPK10)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC3FPK10)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.FEIC5FPK10)
            {
                str = "44";
            }
            return str;
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("翡翠");
            if (flag)
            {

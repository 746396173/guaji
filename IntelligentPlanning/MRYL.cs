namespace IntelligentPlanning
{
    ...
    public class MRYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.MRFFC)
            {
                return "15";
            }
            if (pType == ConfigurationStatus.LotteryType.MR2FC)
            {
                return "16";
            }
            if (pType == ConfigurationStatus.LotteryType.MR45C)
            {
                return "45";
            }
            if (pType == ConfigurationStatus.LotteryType.MR11X5)
            {
                return "18";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.MRPK10)
            {
                str = "83";
            }
            return str;

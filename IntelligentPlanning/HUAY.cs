namespace IntelligentPlanning
{
    ...
    public class HUAY : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HUAY5FC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.HUAY2FC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.HUAYFFC)
            {
                return "8";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HUAY11X5)
            {
                return "104";
            }

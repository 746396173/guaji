namespace IntelligentPlanning
{
    ...
    public class KXYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.KXHGSSC)
            {
                return "56";
            }
            if (pType == ConfigurationStatus.LotteryType.KXBL15C)
            {
                return "44";
            }
            if (pType == ConfigurationStatus.LotteryType.KXWX15C)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.KXFLBSSC)
            {
                return "66";
            }
            if (pType == ConfigurationStatus.LotteryType.KXWBFFC)
            {
                return "49";
            }
            if (pType == ConfigurationStatus.LotteryType.KXYNFFC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.KXYN3FC)
            {
                return "53";
            }
            if (pType == ConfigurationStatus.LotteryType.KXYN5FC)
            {
                return "55";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.KX11X5FFC)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.KX11X53FC)
            {
                return "63";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType) => 
            CommFunc.GetLotteryID(pType).ToLower();
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("凯鑫娱乐");
        }

namespace IntelligentPlanning
{
    ...
    public class CTT : PTBase
    {
                    ...
                    foreach (string str4 in dictionary2.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                str7 = string.Format(str7, new object[] { this.GetBetsLotteryID(plan.Type), this.GetBetsExpect(plan.CurrentExpect, ""), "0", this.GetPlayMethodID(plan.Type, plan.Play), this.GetNumberList(plan.Type, pTNumberList, plan.Play, plan.RXWZ), Convert.ToInt32(plan.AutoTimes(str4, true)), num, plan.Money / 2.0, 1 });
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.CTTFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.CTT5FC)
            {
                return "9";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("彩天堂");
        }

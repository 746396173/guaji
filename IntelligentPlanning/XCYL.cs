namespace IntelligentPlanning
{
    ...
    public class XCYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XCTXFFC)
            {
                return "57";
            }
            if (pType == ConfigurationStatus.LotteryType.XCQQFFC)
            {
                return "58";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XCHGSSC)
            {
                return "56";
            }
            if (pType == ConfigurationStatus.LotteryType.XCFLBSSC)
            {
                return "66";
            }
            if (pType == ConfigurationStatus.LotteryType.XCYNFFC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.XCWX15C)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.XCBL15C)
            {
                return "44";
            }
            if (pType == ConfigurationStatus.LotteryType.XCYN3FC)
            {
                return "53";
            }
            if (pType == ConfigurationStatus.LotteryType.XCYN5FC)
            {
                return "55";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XC11X5FFC)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.XC11X53FC)
            {
                return "63";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("轩彩在线");
        }

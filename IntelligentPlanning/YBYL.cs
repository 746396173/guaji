namespace IntelligentPlanning
{
    ...
    public class YBYL : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.YBFFC)
            {
                return "ffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YB3FC)
            {
                return "3fc";
            }
            if (pType == ConfigurationStatus.LotteryType.YBBLSFFC)
            {
                return "blsffc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YBTXFFC)
            {
                return "xtxffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YBHG15F)
            {
                return "hgxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YBXDL15F)
            {
                return "xdlxyssc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YBNHG15F)
            {
                return "xhgxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YBDJSSC)
            {
                return "xdjxyssc";
            }
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("亿博");
            return true;
        }

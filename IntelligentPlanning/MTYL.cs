namespace IntelligentPlanning
{
    ...
    public class MTYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.MTXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.MTSE15F)
            {
                return "205";
            }
            if (pType == ConfigurationStatus.LotteryType.MTDLD30M)
            {
                return "46";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.MTXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.MTXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.MTHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.MTDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.MTXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.MTLD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.MTNY15C)
            {
                return "206";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.MTPK10)
            {
                str = "204";
            }
            return str;
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.MTSE15F)
            {
                str = "SHOUERSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTDLD30M)
            {
                str = "TG30SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.MTXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTLD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MTNY15C)
            {
                str = "NEWYOSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.MTPK10)
            {
                str = "AKLPK10";
            }
            return str.ToUpper();
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("马泰娱乐");
        }

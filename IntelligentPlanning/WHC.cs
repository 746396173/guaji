namespace IntelligentPlanning
{
    ...
    public class WHC : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WHCFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.WHC3FC)
            {
                return "16";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=WHC&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("万和城");
            if (flag)
            {
                base.Token = CommFunc.GetIndexString(pResponsetext, "value=\"", "\"", pResponsetext.IndexOf("__RequestVerificationToken"));
            }

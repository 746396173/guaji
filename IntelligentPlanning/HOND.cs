namespace IntelligentPlanning
{
    ...
    public class HOND : PTBase
    {
        ...
        public override void CountPrizeDic(string pResponseText)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                if (str3 != "")
                {
                    ...
                    else if (!base.PlayMethodDic.ContainsKey(key))
                    {
                        base.PlayMethodDic[key] = str6;
                    }
                }
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HONDSE15F)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.HONDNY15C)
            {
                return "31";
            }
            if (pType == ConfigurationStatus.LotteryType.HONDHG15F)
            {
                return "26";
            }
            if (pType == ConfigurationStatus.LotteryType.HONDDJ15F)
            {
                return "28";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HONDFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.HOND2FC)
            {
                return "8";
            }
            if (pType == ConfigurationStatus.LotteryType.HOND5FC)
            {
                return "9";
            }
        ...
        public override string GetPlayString(string playName)
        {
            ...
            if (AppInfo.Current.Lottery.Group == ConfigurationStatus.LotteryGroup.GP11X5)
            {
                ...
                if (playName == "任选复式一中一")
                {
                    return "一中一-1-0,1,2,3,4";
                }
                if (playName == "任选复式二中二")
                {
                    return "二中二-2-0,1,2,3,4";
                }
                if (playName == "任选复式三中三")
                {
                    return "三中三-3-0,1,2,3,4";
                }
                if (playName == "任选复式四中四")
                {
                    return "四中四-4-0,1,2,3,4";
                }
                if (playName == "任选复式五中五")
                {
                    return "五中五-5-0,1,2,3,4";
                }
                if (playName == "任选单式一中一")
                {
                    return "一中一-1-0,1,2,3,4-1";
                }
                if (playName == "任选单式二中二")
                {
                    return "二中二-2-0,1,2,3,4-1";
                }
                if (playName == "任选单式三中三")
                {
                    return "三中三-3-0,1,2,3,4-1";
                }
                if (playName == "任选单式四中四")
                {
                    return "四中四-4-0,1,2,3,4-1";
                }
                if (playName == "任选单式五中五")
                {
                    str = "五中五-5-0,1,2,3,4-1";
                }
                return str;
            }
            if (AppInfo.Current.Lottery.Group == ConfigurationStatus.LotteryGroup.GPPK10)
            ...
            try
            {
                if (!this.CheckLotteryIsVR(pType))
                {
                    ...
                    if (base.PlayMethodDic.Count == 0)
                    {
                        ...
                        lotteryLine = this.GetLotteryLine(pType, false);
                        str3 = "";
                        HttpHelper.GetResponse(ref str3, str, "GET", string.Empty, lotteryLine, base.BetsTime2, "UTF-8", true);
        ...
        {
            string indexLine = this.GetIndexLine();
            string pUrl = $"{this.GetLine()}/tp/nvr/login?gametype=&gamecode={this.GetBetsLotteryID(pType)}";
            string pResponsetext = "";
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=HD&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("宏达");
        }

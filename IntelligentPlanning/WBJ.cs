namespace IntelligentPlanning
{
    ...
    public class WBJ : PTBase
    {
        ...
        public override string GetAppExpect(ConfigurationStatus.LotteryType pType, string pExpect, bool pIsBets = false)
        {
            ...
            if (((((pType == ConfigurationStatus.LotteryType.WBJBJSSC) || (pType == ConfigurationStatus.LotteryType.WBJ2FC)) || ((pType == ConfigurationStatus.LotteryType.WBJHG2FC) || (pType == ConfigurationStatus.LotteryType.WBJMSK35C))) || (((pType == ConfigurationStatus.LotteryType.WBJNNPK10) || (pType == ConfigurationStatus.LotteryType.WBJDJSSC)) || ((pType == ConfigurationStatus.LotteryType.WBJHGSSC) || (pType == ConfigurationStatus.LotteryType.WBJXJPSSC)))) || (pType == ConfigurationStatus.LotteryType.WBJJNDSSC))
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WBJBJSSC)
            {
                return "37";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WBJHG2FC)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJDX15C)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJNY15C)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJMSK35C)
            {
                return "32";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJFFC)
            {
                return "24";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJ2FC)
            {
                return "25";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJ5FC)
            {
                return "26";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJTG30)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJXXLSSC)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJDJSSC)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJHGSSC)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.WBJXJPSSC)
            {
                return "44";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJJNDSSC)
            {
                return "45";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WBJOM11X5)
            {
                return "12";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WBJOMPK10)
            {
                return "36";
            }
            if (pType == ConfigurationStatus.LotteryType.WBJNNPK10)
            {
                str = "38";
            }
            return str;
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("旺百家");
            if (flag)
            {

namespace IntelligentPlanning
{
    ...
    public class BKC : PTBase
    {
        ...
        {
            string str = pExpect;
            if (((pType != ConfigurationStatus.LotteryType.BKC2FC) && (pType != ConfigurationStatus.LotteryType.BKC5FC)) && (pType != ConfigurationStatus.LotteryType.JN15F))
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BKCFFC)
            {
                return "18";
            }
            if (pType == ConfigurationStatus.LotteryType.BKC2FC)
            {
                return "22";
            }
            if (pType == ConfigurationStatus.LotteryType.BKC5FC)
            {
                return "17";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BKC11X5FFC)
            {
                return "25";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("博客彩");
        }

namespace IntelligentPlanning
{
    ...
    public class HGDB : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HGDBFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.HGDB5FC)
            {
                return "30";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("红馆迪拜");
        }

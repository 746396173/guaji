namespace IntelligentPlanning
{
    ...
    public class KYYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.KYHGSSC)
            {
                return "56";
            }
            if (pType == ConfigurationStatus.LotteryType.KYBL15C)
            {
                return "44";
            }
            if (pType == ConfigurationStatus.LotteryType.KYWX15C)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.KYFLBSSC)
            {
                return "68";
            }
            if (pType == ConfigurationStatus.LotteryType.KYWBFFC)
            {
                return "49";
            }
            if (pType == ConfigurationStatus.LotteryType.KYYNFFC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.KYYN3FC)
            {
                return "53";
            }
            if (pType == ConfigurationStatus.LotteryType.KYYN5FC)
            {
                return "55";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.KY11X5FFC)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.KY11X53FC)
            {
                return "63";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("开元娱乐");
        }

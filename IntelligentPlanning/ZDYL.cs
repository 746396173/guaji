namespace IntelligentPlanning
{
    ...
    public class ZDYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.ZDTGSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.ZDRBSSC)
            {
                return "23";
            }
            if (pType == ConfigurationStatus.LotteryType.ZDFFC)
            {
                return "11";
            }
            if (pType == ConfigurationStatus.LotteryType.ZD5FC)
            {
                return "4";
            }
            if (pType == ConfigurationStatus.LotteryType.ZDDJSSC)
            {
                return "36";
            }
            if (pType == ConfigurationStatus.LotteryType.ZDHS15F)
            {
                return "42";
            }

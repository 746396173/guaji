namespace IntelligentPlanning
{
    ...
    public class DPC : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.DPCFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.DPC5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.DPCTXFFC)
            {
                return "30001";
            }
            if (pType == ConfigurationStatus.LotteryType.DPCOZBWC)
            {
                return "20051";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("迪拜城");
        }

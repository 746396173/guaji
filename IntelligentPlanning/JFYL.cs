namespace IntelligentPlanning
{
    ...
    public class JFYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JFYLFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.JFYL2FC)
            {
                return "40";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JFYL2F11X5)
            {
                return "39";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=JF&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("玖富娱乐");
            if (flag)
            {
                base.Token = CommFunc.GetIndexString(pResponsetext, "value=\"", "\"", pResponsetext.IndexOf("__RequestVerificationToken"));
            }

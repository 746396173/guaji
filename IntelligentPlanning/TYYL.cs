namespace IntelligentPlanning
{
    ...
    public class TYYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (((((pType != ConfigurationStatus.LotteryType.TYYLHS15F) && (pType != ConfigurationStatus.LotteryType.TYYLDJ15F)) && ((pType != ConfigurationStatus.LotteryType.TYYLXDL15F) && (pType != ConfigurationStatus.LotteryType.TYYLELS15F))) && (((pType != ConfigurationStatus.LotteryType.TYYL30M11X5) && (pType != ConfigurationStatus.LotteryType.TYYLYD15F)) && ((pType != ConfigurationStatus.LotteryType.TYYL90M11X5) && (pType != ConfigurationStatus.LotteryType.TYYL120MPK10)))) && (pType != ConfigurationStatus.LotteryType.TYYL180MPK10))
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.TYYL30M)
            {
                return "t1s30";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLMG60M)
            {
                return "t1s60";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLDJ15F)
            {
                return "t1s90d";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLXJPSSC)
            {
                return "sgssc";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLXDL15F)
            {
                return "t1s90a";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLELS15F)
            {
                return "t1s90b";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYLYD15F)
            {
                return "t1s90c";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.TYYL30M11X5)
            {
                return "t2s30";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYL90M11X5)
            {
                return "t2s90";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.TYYL120MPK10)
            {
                return "t6s120";
            }
            if (pType == ConfigurationStatus.LotteryType.TYYL180MPK10)
            {
                str = "t6s180";
            }
            return str;
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("用户登陆");
        }

namespace IntelligentPlanning
{
    ...
    public class HUIZ : PTBase
    {
                ...
                foreach (string str3 in fNNumberDic.Keys)
                {
                    ...
                    foreach (string str4 in dictionary2.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            format = string.Format(format, new object[] { this.GetBetsLotteryID(plan.Type), this.GetBetsExpect(plan.CurrentExpect, ""), 1, this.GetPlayMethodID(plan.Type, plan.Play), this.GetNumberList1(pTNumberList, plan.Play, plan.RXWZ), base.Rebate, Convert.ToInt32(plan.AutoTimes(str4, true)), plan.Unit - 1, plan.AutoTotalMoney(str4, true), 0 });
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HUIZFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.HUIZ5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HUIZHGSSC)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.HUIZJN15C)
            {
                return "10021";
            }
            if (pType == ConfigurationStatus.LotteryType.HUIZXJPSSC)
            {
                return "10031";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HSAZXYC)
            {
                return "20051";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HUIZFF11X5)
            {
                return "60";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HUIZFFPK10)
            {
                return "40001";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("汇众娱乐");
        }

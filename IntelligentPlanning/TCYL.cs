namespace IntelligentPlanning
{
    ...
    public class TCYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JFYLBHD15C)
            {
                return "76";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JFYLGX2FC)
            {
                return "81";
            }
            if (pType == ConfigurationStatus.LotteryType.TCYLFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.TCYL2FC)
            {
                return "40";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.TCYLFF11X5)
            {
                return "14";
            }
            if (pType == ConfigurationStatus.LotteryType.TCYL2F11X5)
            {
                return "39";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.TCYLFFPK10)
            {
                return "20";
            }
            if (pType == ConfigurationStatus.LotteryType.TCYL2FPK10)
            {
                return "110";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=TEC&data={pVRData}";
            string pResponsetext = "";

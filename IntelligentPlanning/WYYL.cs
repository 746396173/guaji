namespace IntelligentPlanning
{
    ...
    public class WYYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WYFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.WY2FC)
            {
                return "40";
            }
            if (pType == ConfigurationStatus.LotteryType.WY3FC)
            {
                return "16";
            }
            if (pType == ConfigurationStatus.LotteryType.SSHCTXFFC)
            {
                return "59";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WYFF11X5)
            {
                return "14";
            }
            if (pType == ConfigurationStatus.LotteryType.WY2F11X5)
            {
                return "39";
            }
            if (pType == ConfigurationStatus.LotteryType.WY3F11X5)
            {
                return "17";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WYFFPK10)
            {
                return "20";
            }
            if (pType == ConfigurationStatus.LotteryType.WY2FPK10)
            {
                return "110";
            }
            if (pType == ConfigurationStatus.LotteryType.WY3FPK10)
            {
                return "109";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=HY&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb3()
        {
            ...
            bool flag = pResponsetext.Contains("幻影");
            if (flag)
            {
                base.Token = CommFunc.GetIndexString(pResponsetext, "value=\"", "\"", pResponsetext.IndexOf("__RequestVerificationToken"));
            }

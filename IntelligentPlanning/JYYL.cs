namespace IntelligentPlanning
{
    ...
    public class JYYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JYYLTX30M)
            {
                return "50";
            }
            if (pType == ConfigurationStatus.LotteryType.JYYLQQFFC)
            {
                return "61";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JYYLXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.JYYLXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.JYYLLD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.JYYLHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.JYYLDJSSC)
            {
                return "601";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.JYYLTX30M)
            {
                str = "TX30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLQQFFC)
            {
                str = "QQ60SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.JYYLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLLD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.JYYLDJSSC)
            {
                str = "DJSSC";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("鲸鱼娱乐");
        }

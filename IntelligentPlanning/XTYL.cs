namespace IntelligentPlanning
{
    ...
    public class XTYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.XTYLXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XTYLHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.XTYLDLD30M)
            {
                return "46";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XTYLXWYFFC)
            {
                return "119";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XTYLDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.XTYLXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.XTYLLD2FC)
            {
                return "203";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XTYLPK10)
            {
                str = "204";
            }
            return str;
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.XTYLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XTYLHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XTYLDLD30M)
            {
                str = "TG30SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.XTYLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.XTYLDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XTYLXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XTYLLD2FC)
            {
                str = "LD2SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.XTYLPK10)
            {
                str = "AKLPK10";
            }
            return str.ToUpper();

namespace IntelligentPlanning
{
    ...
    public class QQYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.QQYLFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYL5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.QQYLFLP45M)
            {
                return "10012";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLRB45M)
            {
                return "10015";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLMG45M)
            {
                return "10021";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLJND4FC)
            {
                return "10053";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLHG5FC)
            {
                return "10061";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLQQXDL45M)
            {
                return "20012";
            }
            if (pType == ConfigurationStatus.LotteryType.QQYLQQXDL90M)
            {
                return "20052";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.QQYLFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("奇趣娱乐");
        }

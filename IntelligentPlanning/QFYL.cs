namespace IntelligentPlanning
{
    ...
    public class QFYL : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.QFYLFFC)
            {
                return "min1";
            }
            if (pType == ConfigurationStatus.LotteryType.QFYL3FC)
            {
                return "min3";
            }
            if (pType == ConfigurationStatus.LotteryType.QFYL5FC)
            {
                return "min5";
            }
            if (pType == ConfigurationStatus.LotteryType.QFYLDJSSC)
            {
                return "djssc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.QFYLSE15F)
            {
                return "seoul90";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.QFYLNY15C)
            {
                return "nylotto";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.QFYL11X5)
            {
                return "yc11x5";
            }

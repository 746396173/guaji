namespace IntelligentPlanning
{
    ...
    public class THEN : PTBase
    {
        ...
        {
            string str = pExpect;
            if (((((pType != ConfigurationStatus.LotteryType.THEN120MPK10) && (pType != ConfigurationStatus.LotteryType.THEN180MPK10)) && ((pType != ConfigurationStatus.LotteryType.THENJND11X5) && (pType != ConfigurationStatus.LotteryType.THENHGSSC))) && (((pType != ConfigurationStatus.LotteryType.THENDJSSC) && (pType != ConfigurationStatus.LotteryType.THENXDLSSC)) && (pType != ConfigurationStatus.LotteryType.THENELSSSC))) && (pType != ConfigurationStatus.LotteryType.THENYD15C))
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.THENXJP30M)
            {
                return "t1s30";
            }
            if (pType == ConfigurationStatus.LotteryType.THENMGFFC)
            {
                return "t1s60";
            }
            if (pType == ConfigurationStatus.LotteryType.THENHGSSC)
            {
                return "t1s90";
            }
            if (pType == ConfigurationStatus.LotteryType.THENDJSSC)
            {
                return "t1s90d";
            }
            if (pType == ConfigurationStatus.LotteryType.THENXJPSSC)
            {
                return "sgssc";
            }
            if (pType == ConfigurationStatus.LotteryType.THENXDLSSC)
            {
                return "t1s90a";
            }
            if (pType == ConfigurationStatus.LotteryType.THENELSSSC)
            {
                return "t1s90b";
            }
            if (pType == ConfigurationStatus.LotteryType.THENYD15C)
            {
                return "t1s90c";
            }
            if (pType == ConfigurationStatus.LotteryType.THENNY11X5)
            {
                return "t2s30";
            }
            if (pType == ConfigurationStatus.LotteryType.THENJND11X5)
            {
                return "t2s90";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.THEN120MPK10)
            {
                return "t6s120";
            }
            if (pType == ConfigurationStatus.LotteryType.THEN180MPK10)
            {
                str = "t6s180";
            }
            return str;

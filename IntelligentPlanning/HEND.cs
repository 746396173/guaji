namespace IntelligentPlanning
{
    ...
    public class HEND : PTBase
    {
        ...
        public override string GetAccountsMemLine(ConfigurationStatus.LotteryType pType) => 
            (this.GetLine() + "/mobile-users/user-account-info");
        ...
        public override string GetAppExpect(ConfigurationStatus.LotteryType pType, string pExpect, bool pIsBets = false)
        {
            ...
            if (((((pType == ConfigurationStatus.LotteryType.HEND2FC) || (pType == ConfigurationStatus.LotteryType.HENDXJPSSC)) || ((pType == ConfigurationStatus.LotteryType.HENDHG2FC) || (pType == ConfigurationStatus.LotteryType.HENDDJSSC))) || (pType == ConfigurationStatus.LotteryType.HENDHGSSC)) || (pType == ConfigurationStatus.LotteryType.HENDTXPK10))
            {
                if (pIsBets)
                {
            ...
            if (pType != ConfigurationStatus.LotteryType.HENDXDLSSC)
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HENDFFC)
            {
                return "24";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.HEND2FC)
            {
                return "25";
            }
            if (pType == ConfigurationStatus.LotteryType.HEND5FC)
            {
                return "26";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HENDTG30)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDDJSSC)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDNY15C)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDHGSSC)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDDX15C)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDXXLSSC)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDHG1FC)
            {
                return "55";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDHG2FC)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDXJPSSC)
            {
                return "44";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HENDJS11X5)
            {
                return "12";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HENDJSPK10)
            {
                return "57";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDOMPK10)
            {
                return "36";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDFFPK10)
            {
                return "56";
            }
            if (pType == ConfigurationStatus.LotteryType.HENDTXPK10)
            {
                str = "38";
            }
            return str;
        ...
        public override string GetLineString(string pResponseText)
        {
            ...
            for (int i = 0; i < base.LineList.Count; i++)
            {
                if (str == base.LineList[i])
                {
                    return $"{"线路"}{(i + 1)}";
                }
            }
        ...
        public override string GetLoginLine() => 
            (this.GetLine() + "/auth/signin?type=mobile&isencode=1");
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("\"isSuccess\":0");
        }

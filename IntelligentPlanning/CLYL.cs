namespace IntelligentPlanning
{
    ...
    public class CLYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (((((pType == ConfigurationStatus.LotteryType.CLYLAM15C) || (pType == ConfigurationStatus.LotteryType.CLYLTB15C)) || ((pType == ConfigurationStatus.LotteryType.CLYLDJSSC) || (pType == ConfigurationStatus.LotteryType.CLYLXDL15F))) || (pType == ConfigurationStatus.LotteryType.CLYLHGSSC)) && !pIsBets)
            {
                str = str.Remove(8, 1);
            }
            return str;
        ...
        public override void GetSite(ConfigurationStatus.LotteryType pType, string playName = "")
        {
            try
            {
                if (base.Prize == "")
                {
                    ...
                    string pResponsetext = "";
                    string pSource = $"(game_id:{this.GetBetsLotteryID(pType)},game_type_id:{21})";
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("长隆娱乐");
        }

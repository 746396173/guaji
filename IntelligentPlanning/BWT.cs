namespace IntelligentPlanning
{
    ...
    public class BWT : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BWTFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.BWT5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BWTHGSSC)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.BWTDJSSC)
            {
                return "65";
            }
            if (pType == ConfigurationStatus.LotteryType.BWTTXFFC)
            {
                return "30001";
            }
            if (pType == ConfigurationStatus.LotteryType.BWTOZBWC)
            {
                return "20051";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BWT11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("博万通");
        }

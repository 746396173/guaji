namespace IntelligentPlanning
{
    ...
    public class XGLL : PTBase
    {
        ...
        public override string GetAccountsMemLine(ConfigurationStatus.LotteryType pType) => 
            $"{this.GetLine()}/wps/wallets/balance?typeId={2}";
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XGLLWYN30M)
            {
                return "604";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLDJSSC)
            {
                return "201";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLLSJ2FC)
            {
                return "602";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLFLP15C)
            {
                return "2207";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLWNS15C)
            {
                return "603";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLLFFC)
            {
                return "903";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLL2FC)
            {
                return "1503";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XGLLLSY11X5)
            {
                return "902";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XGLLLDPK10)
            {
                return "605";
            }
            if (pType == ConfigurationStatus.LotteryType.XGLLSSPK10)
            {
                str = "1802";
            }
            return str;
        ...
        public override string GetIndexCode(ConfigurationStatus.LotteryType pType) => 
            $"{this.GetLine()}/lgw/draw/{this.GetBetsLotteryID(pType)}?page=0&size=3";

namespace IntelligentPlanning
{
    ...
    public class JHC2 : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JHC2FFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.JHC215C)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.JHC23FC)
            {
                return "16";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JHC2DPFFC)
            {
                return "69";
            }
            if (pType == ConfigurationStatus.LotteryType.JHC2JZFFC)
            {
                return "82";
            }
            if (pType == ConfigurationStatus.LotteryType.JHC2JD15C)
            {
                return "68";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JHC2PK10)
            {
                return "20";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=JH2&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb2()
        {
            string pReferer = "";
            string pUrl = this.GetLine() + "/";
            string pResponsetext = "";
            HttpHelper.GetResponse6(ref pResponsetext, pUrl, "GET", string.Empty, pReferer, 0x2710, "UTF-8", true);
            return pResponsetext.Contains("金皇朝II");
        }
        ...
        public bool LoginWeb3()
        {
            ...
            bool flag = pResponsetext.Contains("金皇朝II");
            if (flag)
            {
                base.Token = CommFunc.GetIndexString(pResponsetext, "value=\"", "\"", pResponsetext.IndexOf("__RequestVerificationToken"));
            }

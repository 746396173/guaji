namespace IntelligentPlanning
{
    ...
    public class HZYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HZQQFFC)
            {
                return "16";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HZ3FC)
            {
                return "3";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HZXXLSSC)
            {
                return "5";
            }
            if (pType == ConfigurationStatus.LotteryType.HZJNDSSC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.HZHG2FC)
            {
                return "48";
            }
            if (pType == ConfigurationStatus.LotteryType.HZXJP2FC)
            {
                return "49";
            }
            if (pType == ConfigurationStatus.LotteryType.HZHGSSC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.HZDJSSC)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.HZXDLSSC)
            {
                return "8";
            }
            if (pType == ConfigurationStatus.LotteryType.HZTG15F)
            {
                return "10";
            }
            if (pType == ConfigurationStatus.LotteryType.HZML15F)
            {
                return "9";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HZFF11X5)
            {
                return "23";
            }
            if (pType == ConfigurationStatus.LotteryType.HZTG11X5)
            {
                return "24";
            }
        ...
        public override string GetLineString(string pResponseText)
        {
            ...
            if (str.Contains("http://www.hz226.com"))
            {
                str = "线路1";
            }
            return str;
        ...
        public override string GetPTHint(string pResponseText)
        {
            ...
            return CommFunc.GetIndexString(pResponseText, "\"state\":", "}", 0);
        }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("华众娱乐");
        }

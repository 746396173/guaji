namespace IntelligentPlanning
{
    ...
    public class LFYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.LFFFC)
            {
                return "8";
            }
            if (pType == ConfigurationStatus.LotteryType.LF2FC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.LF5FC)
            {
                return "6";
            }

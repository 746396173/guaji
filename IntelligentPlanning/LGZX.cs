namespace IntelligentPlanning
{
    ...
    public class LGZX : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.LGZXFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.LGZX3FC)
            {
                return "16";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.LGZX3F11X5)
            {
                return "17";
            }
            if (pType == ConfigurationStatus.LotteryType.LGZXFF11X5)
            {
                return "14";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.LGZXPK10)
            {
                return "20";
            }
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            if (webVerifyCode != "")
            {
                ...
                HttpHelper.GetResponse(ref pResponsetext, pUrl, "POST", pData, loginLine, 0x2710, "UTF-8", true);
                flag = pResponsetext.Contains("个人中心");
                if (!flag)
                {
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=LG&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb2()
        {
            ...
            string pResponsetext = "";
            HttpHelper.GetResponse6(ref pResponsetext, pUrl, "GET", string.Empty, pReferer, 0x2710, "UTF-8", true);
            return pResponsetext.Contains("蓝冠在线");
        }
        ...
        public bool LoginWeb3()
        {
            ...
            bool flag = pResponsetext.Contains("蓝冠在线");
            if (flag)
            {
                base.Token = CommFunc.GetIndexString(pResponsetext, "value=\"", "\"", pResponsetext.IndexOf("__RequestVerificationToken"));
            }

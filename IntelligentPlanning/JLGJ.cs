namespace IntelligentPlanning
{
    ...
    public class JLGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JLGJFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.JLGJ5FC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.JLGJTXFFC)
            {
                return "67";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.JLGJFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("巨龙国际");
        }

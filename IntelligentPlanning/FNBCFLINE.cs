namespace IntelligentPlanning.CustomControls
{
    ...
    public class FNBCFCHLine : UserControl
    {
        ...
        private CheckBox Ckb_BCFCHBX;
        private CheckBox Ckb_BCFCHLen;
        private CheckBox Ckb_BCFCHQX;
        private CheckBox Ckb_BCFCHRe;
        private CheckBox Ckb_BCFCHWen;
        ...
        private Label Lbl_BCFDMSort;
        private Label Lbl_BCFExpect;
        private Label Lbl_BCFRC;
        private Label Lbl_BCFType;
        ...
        private NumericUpDown Nm_BCFExpect;
        ...
        private TextBox Txt_BCFDMSort;
        private TextBox Txt_BCFRC;
        ...
        private void Ckb_BCFCHBX_Click(object sender, EventArgs e)
        {
        ...
        private void Ckb_BCFCHLen_Click(object sender, EventArgs e)
        {
        ...
        private void Ckb_BCFCHQX_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < this.TypeList.Count; i++)
            {
                this.TypeList[i].Checked = true;
        ...
        private void Ckb_BCFCHRe_Click(object sender, EventArgs e)
        {
            List<int> list = new List<int> {
                0,
                1,
        ...
        private void Ckb_BCFCHWen_Click(object sender, EventArgs e)
        {
            List<int> list = new List<int> {
                3,
                4,
        ...
        private void fnbcfchLine_Load(object sender, EventArgs e)
        {
        ...
        public ConfigurationStatus.FNBCFCH GetControlValue(ref string pError)
        {
            ConfigurationStatus.FNBase pInfo = new ConfigurationStatus.FNBCFCH();
            this.BT_Time.GetControlValue(ref pInfo);
            ConfigurationStatus.FNBCFCH fnbcfch = (ConfigurationStatus.FNBCFCH)pInfo;
            fnbcfch.PlayType = this.Cbb_PlayType.Text;
            fnbcfch.PlayName = this.Cbb_PlayName.Text;
            fnbcfch.Unit = this.GetUnit();
            fnbcfch.BetsJKSelect = this.Ckb_BetsJK.Checked;
            fnbcfch.BetsJKValue = this.Txt_BetsJK.Text;
            if (fnbcfch.BetsJKSelect && (fnbcfch.BetsJKValue == ""))
            {
                pError = "至少要输入一个监控形态！";
                this.Txt_BetsJK.Focus();
                return null;
            }
            if (!CommFunc.CheckStringIsRange(fnbcfch.BetsJKValue, "01"))
            {
                pError = "监控形态只能输入0或1！";
                this.Txt_BetsJK.Focus();
                return null;
            }
            fnbcfch.BetsJKMode = this.GetJKMode();
            fnbcfch.RXZJ = this.Txt_RXZJ.Text;
            fnbcfch.RXWZList = this.GetRXWZList();
            if (CommFunc.CheckPlayIsRXDS(this.Play) && (fnbcfch.RXWZList.Count < this.PlayInfo.IndexList.Count))
            {
                pError = $"【{this.Play}】至少要选择{this.PlayInfo.IndexList.Count}个位置！";
            }
            fnbcfch.Mode = this.GetMode();
            if (fnbcfch.BetsJKSelect && (fnbcfch.Mode != ConfigurationStatus.SchemeMode.QQHH))
            {
                pError = "启动监控形态后只能支持【每期换号】规则！";
                return null;
            }
            fnbcfch.ModeExpect = Convert.ToInt32(this.Nm_ModeExpect.Value);
            fnbcfch.FBInfo = this.GetFBType();
            fnbcfch.IsBetsZJ = this.Rdb_CodeType1.Checked;
            fnbcfch.BTType = this.GetTimesType();
            fnbcfch.BTPlanList = CommFunc.SplitString(this.Txt_BTPlan.Text.Replace("，", ","), ",", -1);
            if (this.Rdb_BTPlan.Checked && (fnbcfch.BTPlanList.Count == 0))
            {
                pError = "至少要输入一个直线倍投！";
                this.Txt_BTPlan.Focus();
                return null;
            }
            foreach (string str in fnbcfch.BTPlanList)
            {
            ...
            fnbcfch.BTFNName = this.Cbb_BTFN.Text;
            fnbcfch.VisibleMore = this.IsMore;
            fnbcfch.BCFExpect = Convert.ToInt32(this.Nm_BCFExpect.Value);
            fnbcfch.BCFTypeList = this.GetBCFTypeList();
            if (fnbcfch.BCFTypeList.Count == 0)
            {
                pError = "至少要选择一个出号类型！";
                return null;
            }
            fnbcfch.BCFRC = this.Txt_BCFRC.Text;
            if (fnbcfch.BCFRC == "")
            {
                pError = "至少要输入一个出号个数！";
                this.Txt_BCFRC.Focus();
                return null;
            }
            fnbcfch.ZSBetsSelect1 = this.Ckb_MN1.Checked;
            fnbcfch.ZSBetsSelect2 = this.Ckb_MN3.Checked;
            fnbcfch.MNBetsSelect1 = this.Ckb_MN2.Checked;
            fnbcfch.MNBetsSelect2 = this.Ckb_MN4.Checked;
            fnbcfch.ZSBetsMoney1 = this.Txt_MN1.Text;
            fnbcfch.ZSBetsMoney2 = this.Txt_MN3.Text;
            fnbcfch.MNBetsMoney1 = this.Txt_MN2.Text;
            fnbcfch.MNBetsMoney2 = this.Txt_MN4.Text;
            ...
            fnbcfch.YLStopSelect = this.Ckb_YLStopBets.Checked;
            fnbcfch.KSStopSelect = this.Ckb_KSStopBets.Checked;
            fnbcfch.YLStopMoney = this.Txt_YLStopBets.Text;
            fnbcfch.KSStopMoney = this.Txt_KSStopBets.Text;
            return fnbcfch;
        }
        ...
        private List<int> GetBCFTypeList()
        {
            List<int> list = new List<int>();
            for (int i = 0; i < this.TypeList.Count; i++)
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.Lbl_BCFDMSort = new Label();
            this.Txt_BCFRC = new TextBox();
            this.Txt_BCFDMSort = new TextBox();
            this.Lbl_BCFRC = new Label();
            this.Lbl_BCFExpect = new Label();
            this.Nm_BCFExpect = new NumericUpDown();
            this.Lbl_BCFType = new Label();
            ...
            this.Ckb_BCFCHQX = new CheckBox();
            this.Ckb_BCFCHBX = new CheckBox();
            this.Ckb_BCFCHRe = new CheckBox();
            this.Ckb_BCFCHLen = new CheckBox();
            this.Ckb_BCFCHWen = new CheckBox();
            ...
            this.Pnl_MainInfo.Controls.Add(this.Ckb_BCFCHWen);
            this.Pnl_MainInfo.Controls.Add(this.Ckb_BCFCHLen);
            this.Pnl_MainInfo.Controls.Add(this.Ckb_BCFCHRe);
            this.Pnl_MainInfo.Controls.Add(this.Ckb_BCFCHQX);
            this.Pnl_MainInfo.Controls.Add(this.Ckb_BCFCHBX);
            ...
            this.Pnl_MainInfo.Controls.Add(this.Lbl_BCFDMSort);
            this.Pnl_MainInfo.Controls.Add(this.Txt_BCFRC);
            this.Pnl_MainInfo.Controls.Add(this.Txt_BCFDMSort);
            this.Pnl_MainInfo.Controls.Add(this.Lbl_BCFRC);
            this.Pnl_MainInfo.Controls.Add(this.Lbl_BCFExpect);
            this.Pnl_MainInfo.Controls.Add(this.Nm_BCFExpect);
            this.Pnl_MainInfo.Controls.Add(this.Lbl_BCFType);
            ...
            this.Lbl_BCFDMSort.AutoSize = true;
            this.Lbl_BCFDMSort.Location = new Point(5, 8);
            this.Lbl_BCFDMSort.Name = "Lbl_BCFDMSort";
            this.Lbl_BCFDMSort.Size = new Size(0x44, 0x11);
            this.Lbl_BCFDMSort.TabIndex = 0x9e;
            this.Lbl_BCFDMSort.Text = "胆码排序：";
            this.Txt_BCFRC.Location = new Point(80, 0x9a);
            this.Txt_BCFRC.Name = "Txt_BCFRC";
            this.Txt_BCFRC.Size = new Size(0xe5, 0x17);
            this.Txt_BCFRC.TabIndex = 0xa4;
            this.Txt_BCFRC.Text = "1-2";
            this.Txt_BCFDMSort.Location = new Point(80, 5);
            this.Txt_BCFDMSort.Name = "Txt_BCFDMSort";
            this.Txt_BCFDMSort.ReadOnly = true;
            this.Txt_BCFDMSort.Size = new Size(0xa6, 0x17);
            this.Txt_BCFDMSort.TabIndex = 0x9f;
            this.Lbl_BCFRC.AutoSize = true;
            this.Lbl_BCFRC.Location = new Point(5, 0x9d);
            this.Lbl_BCFRC.Name = "Lbl_BCFRC";
            this.Lbl_BCFRC.Size = new Size(0x44, 0x11);
            this.Lbl_BCFRC.TabIndex = 0xa3;
            this.Lbl_BCFRC.Text = "容错个数：";
            this.Lbl_BCFExpect.AutoSize = true;
            this.Lbl_BCFExpect.Location = new Point(5, 0x2b);
            this.Lbl_BCFExpect.Name = "Lbl_BCFExpect";
            this.Lbl_BCFExpect.Size = new Size(0x44, 0x11);
            this.Lbl_BCFExpect.TabIndex = 160;
            this.Lbl_BCFExpect.Text = "统计期数：";
            this.Nm_BCFExpect.Location = new Point(80, 40);
            bits = new int[4];
            bits[0] = 0x3e8;
            this.Nm_BCFExpect.Maximum = new decimal(bits);
            bits = new int[4];
            bits[0] = 1;
            this.Nm_BCFExpect.Minimum = new decimal(bits);
            this.Nm_BCFExpect.Name = "Nm_BCFExpect";
            this.Nm_BCFExpect.Size = new Size(0xe5, 0x17);
            this.Nm_BCFExpect.TabIndex = 0xa1;
            bits = new int[4];
            bits[0] = 10;
            this.Nm_BCFExpect.Value = new decimal(bits);
            this.Nm_BCFExpect.ValueChanged += new EventHandler(this.Nm_BCFExpect_ValueChanged);
            this.Lbl_BCFType.AutoSize = true;
            this.Lbl_BCFType.Location = new Point(5, 0x54);
            this.Lbl_BCFType.Name = "Lbl_BCFType";
            this.Lbl_BCFType.Size = new Size(0x44, 0x11);
            this.Lbl_BCFType.TabIndex = 0xa2;
            this.Lbl_BCFType.Text = "出号类型：";
            ...
            this.Ckb_BCFCHQX.Appearance = Appearance.Button;
            this.Ckb_BCFCHQX.AutoCheck = false;
            this.Ckb_BCFCHQX.FlatAppearance.BorderSize = 0;
            this.Ckb_BCFCHQX.FlatStyle = FlatStyle.Flat;
            this.Ckb_BCFCHQX.Location = new Point(0xd7, 0x79);
            this.Ckb_BCFCHQX.Name = "Ckb_BCFCHQX";
            this.Ckb_BCFCHQX.Size = new Size(40, 0x19);
            this.Ckb_BCFCHQX.TabIndex = 0x11e;
            this.Ckb_BCFCHQX.Text = "全选";
            this.Ckb_BCFCHQX.TextAlign = ContentAlignment.MiddleCenter;
            this.Ckb_BCFCHQX.TextImageRelation = TextImageRelation.ImageBeforeText;
            this.Ckb_BCFCHQX.UseVisualStyleBackColor = true;
            this.Ckb_BCFCHQX.Click += new EventHandler(this.Ckb_BCFCHQX_Click);
            this.Ckb_BCFCHBX.Appearance = Appearance.Button;
            this.Ckb_BCFCHBX.AutoCheck = false;
            this.Ckb_BCFCHBX.FlatAppearance.BorderSize = 0;
            this.Ckb_BCFCHBX.FlatStyle = FlatStyle.Flat;
            this.Ckb_BCFCHBX.Location = new Point(0x105, 0x79);
            this.Ckb_BCFCHBX.Name = "Ckb_BCFCHBX";
            this.Ckb_BCFCHBX.Size = new Size(40, 0x19);
            this.Ckb_BCFCHBX.TabIndex = 0x11f;
            this.Ckb_BCFCHBX.Text = "不选";
            this.Ckb_BCFCHBX.TextAlign = ContentAlignment.MiddleCenter;
            this.Ckb_BCFCHBX.TextImageRelation = TextImageRelation.ImageBeforeText;
            this.Ckb_BCFCHBX.UseVisualStyleBackColor = true;
            this.Ckb_BCFCHBX.Click += new EventHandler(this.Ckb_BCFCHBX_Click);
            this.Ckb_BCFCHRe.Appearance = Appearance.Button;
            this.Ckb_BCFCHRe.AutoCheck = false;
            this.Ckb_BCFCHRe.FlatAppearance.BorderSize = 0;
            this.Ckb_BCFCHRe.FlatStyle = FlatStyle.Flat;
            this.Ckb_BCFCHRe.Location = new Point(0x4f, 0x79);
            this.Ckb_BCFCHRe.Name = "Ckb_BCFCHRe";
            this.Ckb_BCFCHRe.Size = new Size(40, 0x19);
            this.Ckb_BCFCHRe.TabIndex = 0x120;
            this.Ckb_BCFCHRe.Text = "不重复前";
            this.Ckb_BCFCHRe.TextAlign = ContentAlignment.MiddleCenter;
            this.Ckb_BCFCHRe.TextImageRelation = TextImageRelation.ImageBeforeText;
            this.Ckb_BCFCHRe.UseVisualStyleBackColor = true;
            this.Ckb_BCFCHRe.Click += new EventHandler(this.Ckb_BCFCHRe_Click);
            this.Ckb_BCFCHLen.Appearance = Appearance.Button;
            this.Ckb_BCFCHLen.AutoCheck = false;
            this.Ckb_BCFCHLen.FlatAppearance.BorderSize = 0;
            this.Ckb_BCFCHLen.FlatStyle = FlatStyle.Flat;
            this.Ckb_BCFCHLen.Location = new Point(0x7d, 0x79);
            this.Ckb_BCFCHLen.Name = "Ckb_BCFCHLen";
            this.Ckb_BCFCHLen.Size = new Size(40, 0x19);
            this.Ckb_BCFCHLen.TabIndex = 0x121;
            this.Ckb_BCFCHLen.Text = "不重复后";
            this.Ckb_BCFCHLen.TextAlign = ContentAlignment.MiddleCenter;
            this.Ckb_BCFCHLen.TextImageRelation = TextImageRelation.ImageBeforeText;
            this.Ckb_BCFCHLen.UseVisualStyleBackColor = true;
            this.Ckb_BCFCHLen.Click += new EventHandler(this.Ckb_BCFCHLen_Click);
            this.Ckb_BCFCHWen.Appearance = Appearance.Button;
            this.Ckb_BCFCHWen.AutoCheck = false;
            this.Ckb_BCFCHWen.FlatAppearance.BorderSize = 0;
            this.Ckb_BCFCHWen.FlatStyle = FlatStyle.Flat;
            this.Ckb_BCFCHWen.Location = new Point(0xab, 0x79);
            this.Ckb_BCFCHWen.Name = "Ckb_BCFCHWen";
            this.Ckb_BCFCHWen.Size = new Size(40, 0x19);
            this.Ckb_BCFCHWen.TabIndex = 290;
            this.Ckb_BCFCHWen.Text = "不重复中";
            this.Ckb_BCFCHWen.TextAlign = ContentAlignment.MiddleCenter;
            this.Ckb_BCFCHWen.TextImageRelation = TextImageRelation.ImageBeforeText;
            this.Ckb_BCFCHWen.UseVisualStyleBackColor = true;
            this.Ckb_BCFCHWen.Click += new EventHandler(this.Ckb_BCFCHWen_Click);
            ...
            base.Name = "fnbcfchLine";
            base.Size = new Size(0x20d, 0x2ad);
            base.Load += new EventHandler(this.fnbcfchLine_Load);
        ...
        private void Nm_BCFExpect_ValueChanged(object sender, EventArgs e)
        {
            this.RefreshSortMain();
        }
        ...
        private void RefreshSortMain()
        {
            ...
            {
                string pError = "";
                this.Txt_BCFDMSort.Text = "";
                ConfigurationStatus.FNBCFCH controlValue = this.GetControlValue(ref pError);
                if (controlValue != null)
                {
                    List<ConfigurationStatus.OpenData> dataList = AppInfo.DataList;
                    List<string> pList = controlValue.RefreshSort(controlValue.BCFPlayIndexList, dataList, 0);
                    this.Txt_BCFDMSort.Text = CommFunc.Join(pList);
                }
            }
        }
        ...
        public void SetControlValue(ConfigurationStatus.FNBase pInfo)
        {
            ...
            this.Txt_RXZJ.Text = fnbcfch.RXZJ;
            this.SetRXWZList(fnbcfch.RXWZList);
            ...
            this.Nm_BCFExpect.Value = fnbcfch.BCFExpect;
            this.SetBCFTypeList(fnbcfch.BCFTypeList);
            this.Txt_BCFRC.Text = fnbcfch.BCFRC;
        ...
        private void SetBCFTypeList(List<int> pValueList)
        {
            List<int> list = new List<int>();
            for (int i = 0; i < this.TypeList.Count; i++)
            {

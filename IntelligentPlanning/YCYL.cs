namespace IntelligentPlanning
{
    ...
    public class YCYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.YCYLFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.YCYL5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YCYLTXFFC)
            {
                return "67";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YCYLFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("亿城娱乐");
        }

namespace IntelligentPlanning
{
    ...
    public class FLC : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.FLCFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.FLC2FC)
            {
                return "8";
            }
            if (pType == ConfigurationStatus.LotteryType.FLC5FC)
            {
                return "9";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("菲洛城");
        }

namespace IntelligentPlanning
{
    ...
    public class DEJI : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.DEJIFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJI5FC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.ALGJOZBWC)
            {
                return "20051";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJITXFFC)
            {
                return "67";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.DEJIFLP45M)
            {
                return "10012";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIRB45M)
            {
                return "10015";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIMG45M)
            {
                return "10013";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIJND4FC)
            {
                return "10053";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIHG5FC)
            {
                return "10061";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIQQXDL45M)
            {
                return "20012";
            }
            if (pType == ConfigurationStatus.LotteryType.DEJIQQXDL90M)
            {
                return "20052";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.DEJIFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("德晋娱乐");
        }

namespace IntelligentPlanning
{
    ...
    public class BLGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BLGJFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.BLGJ5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BLGJTXFFC)
            {
                return "30001";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BLGJFLP45M)
            {
                return "10012";
            }
            if (pType == ConfigurationStatus.LotteryType.BLGJYN15C)
            {
                return "10022";
            }
            if (pType == ConfigurationStatus.LotteryType.BLGJXDL45M)
            {
                return "20011";
            }
            if (pType == ConfigurationStatus.LotteryType.BLGJXDL90M)
            {
                return "20053";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BLGJFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("博乐国际");
        }

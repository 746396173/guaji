namespace IntelligentPlanning
{
    ...
    public class WZYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.WZYLTG11X5)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WZYLJDSSC)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLTXFFC)
            {
                return "11";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLHGSSC)
            {
                return "31";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLHG1FC)
            {
                return "45";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLDJSSC)
            {
                return "36";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLXJPSSC)
            {
                return "34";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLXGSSC)
            {
                return "34";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLLSWJS15C)
            {
                return "64";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLMG35C)
            {
                return "63";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLBL1FC)
            {
                return "65";
            }
            if (pType == ConfigurationStatus.LotteryType.WZYLMG15C)
            {
                return "66";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WZYLBL11X5)
            {
                return "61";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WZYLJSPK10)
            {
                return "47";
            }

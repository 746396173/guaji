namespace IntelligentPlanning
{
    ...
    public class CBL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.CBLXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.CBLDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.CBLXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.CBLLD2FC)
            {
                return "203";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CBLHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.CBLDLD30M)
            {
                return "46";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CBLXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.CBLSE15F)
            {
                return "205";
            }
            if (pType == ConfigurationStatus.LotteryType.CBLNY15C)
            {
                return "206";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CBLPK10)
            {
                str = "204";
            }
            return str;
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.CBLDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLLD2FC)
            {
                str = "LD2SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CBLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLDLD30M)
            {
                str = "TG30SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CBLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLSE15F)
            {
                str = "SHOUERSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CBLNY15C)
            {
                str = "NEWYOSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CBLPK10)
            {
                str = "AKLPK10";
            }
            return str.ToUpper();
        ...
        public bool LoginWeb()
        {
            ...
            return (pResponsetext.Contains("彩部落") || pResponsetext.Contains("彩部洛"));
        }

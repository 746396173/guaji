namespace IntelligentPlanning
{
    ...
    public class SLTH : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.SLTHHGSSC)
            {
                return "72";
            }
            if (pType == ConfigurationStatus.LotteryType.SLTHNHGSSC)
            {
                return "71";
            }
            if (pType == ConfigurationStatus.LotteryType.SLTHDJSSC)
            {
                return "73";
            }
            if (pType == ConfigurationStatus.LotteryType.SLTHFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.SLTH2FC)
            {
                return "40";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.SLTHTEQ15C)
            {
                return "95";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=SLT&data={pVRData}";
            string pResponsetext = "";

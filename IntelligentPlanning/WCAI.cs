namespace IntelligentPlanning
{
    ...
    public class WCAI : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.WCAIXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WCAIHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAIDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAIXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.WCAIXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAIXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAILD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAIMBE30M)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.WCAITWSSC)
            {
                return "811";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.WCAIHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAIDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAIXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAIXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAIXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAILD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAIMBE30M)
            {
                str = "TG30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.WCAITWSSC)
            {
                str = "TWSSC";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("万彩娱乐");
        }

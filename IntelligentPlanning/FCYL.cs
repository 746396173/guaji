namespace IntelligentPlanning
{
    ...
    public class FCYL : PTBase
    {
                ...
                for (int j = 0; j < list2.Count; j++)
                {
                    ...
                    for (int k = 0; k < list3.Count; k++)
                    {
                        ...
                        for (int m = 0; m < list4.Count; m++)
                        {
                            ...
                            base.PrizeDic[str9] = CommFunc.GetIndexString(str7, "\"MxO\":\"", "\"", 0);
                        }
                    }
                }
            }
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.FCOZ3FC)
            {
                return "68";
            }
            if (pType == ConfigurationStatus.LotteryType.FCSLFK5FC)
            {
                return "66";
            }

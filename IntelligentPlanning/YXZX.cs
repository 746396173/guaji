namespace IntelligentPlanning
{
    ...
    public class YXZX : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.YXZXQQFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXMG15C)
            {
                return "25";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXSE15C)
            {
                return "26";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXNY15C)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXXDLSSC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXNHGSSC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXNDJSSC)
            {
                return "31";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXFLP15C)
            {
                return "33";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXJND35C)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXJND5FC)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXXXLSSC)
            {
                return "15";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXHN45M)
            {
                return "16";
            }
            if (pType == ConfigurationStatus.LotteryType.YXZXMG45M)
            {
                return "17";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YXZXTW11X5)
            {
                return "120";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YXZXTWPK10)
            {
                str = "420";
            }
            return str;
        ...
        public string GetNumberList(ConfigurationStatus.LotteryType pType, List<string> pNumberList, string playName, List<int> pRXWZ = null)
        {
            ...
            if (AppInfo.Current.Lottery.Group == ConfigurationStatus.LotteryGroup.GPSSC)
            {
                ...
                else if (CommFunc.CheckPlayIsLH(playName))
                {
                    ...
                    {
                        pList.Add(AppInfo.LHDic[str3].ToString());
                    }
        ...
        public bool GetVRData(ConfigurationStatus.LotteryType pType, ref string pVRData)
        {
            ...
            string pUrl = $"https://tianboksimwpls.bidaao.com/vr/logingame?tocken={HttpHelper.BetsTokenValue}";
            string pResponsetext = "";
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            string pData = $"loginName={pID}&pwd={str4}";
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=YXZX&data={pVRData}";
            string pResponsetext = "";
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("永信在线");
        }

namespace IntelligentPlanning
{
    ...
    public class LDYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.LDYLWX15C)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYLBL15C)
            {
                return "44";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.LDYLWBFFC)
            {
                return "49";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYLFLBSSC)
            {
                return "66";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYLHGSSC)
            {
                return "56";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.LDYLFFC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYL3FC)
            {
                return "53";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYL5FC)
            {
                return "55";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.LDYL11X5FFC)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.LDYL11X53FC)
            {
                return "63";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("立鼎娱乐");
        }

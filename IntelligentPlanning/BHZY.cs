namespace IntelligentPlanning
{
    ...
    public class BHZY : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BHZYFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.BHZY5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BHZYHGSSC)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.BHZYDJSSC)
            {
                return "65";
            }
            if (pType == ConfigurationStatus.LotteryType.BHZYTXFFC)
            {
                return "67";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("新火");
        }

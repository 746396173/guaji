namespace IntelligentPlanning
{
    ...
    public class XWYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.XWYLXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XWYLXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLXJPSSC)
            {
                return "51";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XWYLFL30M)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLTX30M)
            {
                return "50";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLQQFFC)
            {
                return "61";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLLD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLSE15F)
            {
                return "205";
            }
            if (pType == ConfigurationStatus.LotteryType.XWYLNY15C)
            {
                return "206";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.XWYLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLXJPSSC)
            {
                str = "XJPSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.XWYLFL30M)
            {
                str = "TG30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLTX30M)
            {
                str = "TX30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLQQFFC)
            {
                str = "QQ60SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLLD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLSE15F)
            {
                str = "SHOUERSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.XWYLNY15C)
            {
                str = "NEWYOSSC";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("鑫旺娱乐");
        }

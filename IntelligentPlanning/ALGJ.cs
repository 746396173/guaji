namespace IntelligentPlanning
{
    ...
    public class ALGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.ALGJFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.ALGJ5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.ALGJRB15C)
            {
                return "65";
            }
            if (pType == ConfigurationStatus.LotteryType.ALGJSE15C)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.ALGJTXFFC)
            {
                return "67";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.ALGJFF11X5)
            {
                return "60";
            }
            ...
            try
            {
                if (base.Prize == "")
                {
                    ...
                    if (pResponsetext != "")
                    {
                        ...
                        if (Convert.ToDouble(base.Rebate) > 80.0)
                        {
                            base.Rebate = "80";
                        }
                    }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("K5国际娱乐");
        }

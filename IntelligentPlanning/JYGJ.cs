namespace IntelligentPlanning
{
    ...
    public class JYGJ : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.JYINFFC)
            {
                return "ffc";
            }
            if (pType == ConfigurationStatus.LotteryType.JYIN3FC)
            {
                return "3fc";
            }
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            if (webVerifyCode != "")
            {
                ...
                string pUrl = this.GetLine() + "/ct-data/acegi/j_acegi_security_check";
                string pResponsetext = "";
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("久赢国际");
        }

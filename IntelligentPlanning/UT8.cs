namespace IntelligentPlanning
{
    ...
    public class UT8 : PTBase
    {
        public string BetPrize = "";
                ...
                foreach (string str3 in fNNumberDic.Keys)
                {
                    ...
                    foreach (string str4 in dictionary2.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            str8 = string.Format(str8, new object[] { str9, this.GetPlayMethodID(plan.Type, plan.Play), plan.AutoTotalMoney(str4, true), num, Convert.ToInt32(plan.AutoTimes(str4, true)), num2, base.Rebate, this.BetPrize, format, plan.AutoTotalMoney(str4, true), num, 1, 1, this.GetPTLotteryName(plan.Type), this.GetBetsExpect(plan.CurrentExpect, "") });
        ...
        public override string GetLineString(string pResponseText)
        {
            ...
            if (str.Contains("http://ut8.club"))
            {
                return "线路1";
            }
            if (str.Contains("http://youtinghui.club"))
            {
                str = "线路2";
            }
            return str;
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.UT8HGSSC)
            {
                return "xhgxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.UT8DJSSC)
            {
                return "xdjxyssc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.UT8FFC)
            {
                return "ffc";
            }
            if (pType == ConfigurationStatus.LotteryType.UT83FC)
            {
                return "3fc";
            }
            if (pType == ConfigurationStatus.LotteryType.LD2FC)
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("游艇会");
            return true;
        }

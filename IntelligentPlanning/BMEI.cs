namespace IntelligentPlanning
{
    ...
    public class BMEI : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.BMEIFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.BMEI5FC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.DPCDJSSC)
            {
                return "65";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BMTXFFC)
            {
                return "67";
            }
            if (pType == ConfigurationStatus.LotteryType.BMEISE15F)
            {
                return "47";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.BMHGSSC)
            {
                return "10021";
            }
            if (pType == ConfigurationStatus.LotteryType.BMDJSSC)
            {
                return "10022";
            }
            if (pType == ConfigurationStatus.LotteryType.BMFLBSSC)
            {
                return "10023";
            }
            if (pType == ConfigurationStatus.LotteryType.BMTWFFC)
            {
                return "10002";
            }
            if (pType == ConfigurationStatus.LotteryType.BMQQFFC)
            {
                return "10001";
            }
            if (pType == ConfigurationStatus.LotteryType.ALGJNTXFFC)
            {
                return "30001";
            }
        ...
        public override string GetPTHint(string pResponseText)
        {
            ...
            str = CommFunc.UniconToString(CommFunc.GetIndexString(pResponseText, "\"remark\": \"", "\"", 0).Replace("!", ""));
            if (str == "")
            {
                CommFunc.UniconToString(CommFunc.GetIndexString(pResponseText, "\"message\": \"", "\"", 0).Replace("!", ""));
            }
            return str;
        }
            ...
            try
            {
                if (base.Prize == "")
                {
                    ...
                    if (pResponsetext != "")
                    {
                        ...
                        if (Convert.ToDouble(base.Rebate) > 78.0)
                        {
                            base.Rebate = "78";
                        }
                    }
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            if (webVerifyCode != "")
            {
                ...
                string pData = $"user_name={pID}&password={str5}&valid_code={webVerifyCode}";
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("博美");
        }

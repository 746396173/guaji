namespace IntelligentPlanning
{
    ...
    public class MINC : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.MINCTXFFC)
            {
                return "29";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.MINCDJSSC)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.MINCSE15F)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.MINCNY15C)
            {
                return "31";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.MINCFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.MINC2FC)
            {
                return "8";
            }
            if (pType == ConfigurationStatus.LotteryType.MINC5FC)
            {
                return "9";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("名城娱乐");
        }

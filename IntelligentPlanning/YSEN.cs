namespace IntelligentPlanning
{
    ...
    public class YSEN : PTBase
    {
        ...
        public override string GetAppExpect(ConfigurationStatus.LotteryType pType, string pExpect, bool pIsBets = false)
        {
            ...
            if (((((pType == ConfigurationStatus.LotteryType.YSEN2FC) || (pType == ConfigurationStatus.LotteryType.YSENDL2FC)) || ((pType == ConfigurationStatus.LotteryType.YSENXJPSSC) || (pType == ConfigurationStatus.LotteryType.YSENJNDSSC))) || (((pType == ConfigurationStatus.LotteryType.YSENJZ15C) || (pType == ConfigurationStatus.LotteryType.YSENDJSSC)) || (pType == ConfigurationStatus.LotteryType.YSENXGSSC))) || (pType == ConfigurationStatus.LotteryType.YSENXGPK10))
            {
                if (pIsBets)
                {
            ...
            if (pType != ConfigurationStatus.LotteryType.YSENXDLSSC)
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.YSENXGSSC)
            {
                return "39";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENBJSSC)
            {
                return "37";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENFFC)
            {
                return "24";
            }
            if (pType == ConfigurationStatus.LotteryType.YSEN2FC)
            {
                return "25";
            }
            if (pType == ConfigurationStatus.LotteryType.YSEN5FC)
            {
                return "26";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENXGBFC)
            {
                return "46";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENDM45C)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENDL2FC)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENDJ35C)
            {
                return "32";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENXJPSSC)
            {
                return "44";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENJNDSSC)
            {
                return "45";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENHGSSC)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENLT15C)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.YSENJZ15C)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENDJSSC)
            {
                return "43";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YSENJZ11X5)
            {
                return "12";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.YSENTBPK10)
            {
                return "36";
            }
            if (pType == ConfigurationStatus.LotteryType.YSENXGPK10)
            {
                str = "38";
            }
            return str;
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            flag = pResponsetext.Contains("账户管理");
            if (!flag)
            {
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("亿升");
            if (flag)
            {

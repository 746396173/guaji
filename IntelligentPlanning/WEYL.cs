namespace IntelligentPlanning
{
    ...
    public class WEYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WEFFC)
            {
                return "15";
            }
            if (pType == ConfigurationStatus.LotteryType.WE2FC)
            {
                return "16";
            }
            if (pType == ConfigurationStatus.LotteryType.WE45C)
            {
                return "45";
            }
            if (pType == ConfigurationStatus.LotteryType.WETXFFC)
            {
                return "6";
            }
            if (pType == ConfigurationStatus.LotteryType.WEAM15C)
            {
                return "22";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WE11X5)
            {
                return "18";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WEPK10)
            {
                str = "83";
            }
            return str;
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("WE娱乐");
        }

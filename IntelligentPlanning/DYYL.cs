namespace IntelligentPlanning
{
    ...
    public class DYYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if ((((pType == ConfigurationStatus.LotteryType.XJSSC) || (pType == ConfigurationStatus.LotteryType.SD11X5)) || (pType == ConfigurationStatus.LotteryType.GD11X5)) || (pType == ConfigurationStatus.LotteryType.JX11X5))
            {
                if (pIsBets)
                {
                    str = str.Replace("-0", "");
            ...
            if (pType == ConfigurationStatus.LotteryType.DYDJSSC)
            {
                if (pIsBets)
                {
            ...
            if ((pType == ConfigurationStatus.LotteryType.AH11X5) || (pType == ConfigurationStatus.LotteryType.FJ11X5))
            {
                if (pIsBets)
                {
                    return ("20" + str);
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.DYFFC)
            {
                return "13";
            }
            if (pType == ConfigurationStatus.LotteryType.DYDJSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.DYHGSSC)
            {
                return "33";
            }
            if (pType == ConfigurationStatus.LotteryType.DY2FC)
            {
                return "32";
            }
            if (pType == ConfigurationStatus.LotteryType.DY3FC)
            {
                return "17";
            }
            if (pType == ConfigurationStatus.LotteryType.DY5FC)
            {
                return "18";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.DYFF11X5)
            {
                return "14";
            }
            if (pType == ConfigurationStatus.LotteryType.DY2F11X5)
            {
                return "34";
            }
            if (pType == ConfigurationStatus.LotteryType.DY3F11X5)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.DY5F11X5)
            {
                return "36";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.DYFFPK10)
            {
                return "41";
            }
            if (pType == ConfigurationStatus.LotteryType.DY2FPK10)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.DY3FPK10)
            {
                return "43";
            }
            if (pType == ConfigurationStatus.LotteryType.DY5FPK10)
            {
                str = "44";
            }
            return str;
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("斗鱼");
            if (flag)
            {

namespace IntelligentPlanning
{
    ...
    public class YHYL : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.YHYLTXFFC)
            {
                return "xtxffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLQQFFC)
            {
                return "qqffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLWXFFC)
            {
                return "wxffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLFLPFFC)
            {
                return "flbffxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLJNDFFC)
            {
                return "jndyfxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLBLSFFC)
            {
                return "blsffc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLXHG15F)
            {
                return "xhgxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLXDL15F)
            {
                return "xdlxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLFLP2FC)
            {
                return "flblfxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLFLP45M)
            {
                return "flbswmxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLXHG45M)
            {
                return "xhgswmxyssc";
            }
            if (pType == ConfigurationStatus.LotteryType.YHYLBD45M)
            {
                return "bdswmxyssc";
            }
        ...
        public bool LoginWeb()
        {
            ...
            bool flag = pResponsetext.Contains("亿皇");
            return true;
        }

namespace IntelligentPlanning
{
    ...
    public class XHDF : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XHDFFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.XHDF5FC)
            {
                return "30";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XHDFHGSSC)
            {
                return "47";
            }
            if (pType == ConfigurationStatus.LotteryType.XHDFDJSSC)
            {
                return "65";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XHDFTXFFC)
            {
                return "67";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("新火巅峰");
        }

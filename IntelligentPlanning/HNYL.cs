namespace IntelligentPlanning
{
    ...
    public class HNYL : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HNYL5FC)
            {
                return "min5";
            }
            if (pType == ConfigurationStatus.LotteryType.HNYLFFC)
            {
                return "min1";
            }
            if (pType == ConfigurationStatus.LotteryType.HNYLFLP15C)
            {
                return "phssc";
            }
            if (pType == ConfigurationStatus.LotteryType.HNYLXJPSSC)
            {
                return "xjpssc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.HNYL11X5)
            {
                return "yc11x5";
            }

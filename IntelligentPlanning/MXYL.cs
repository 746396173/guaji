namespace IntelligentPlanning
{
    ...
    public class MXYL : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.MXYLXDLSSC)
            {
                if (pIsBets)
                {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.MXYLHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLXDLSSC)
            ...
            if (pType == ConfigurationStatus.LotteryType.MXYLXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLLD2FC)
            {
                return "203";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLTX30M)
            {
                return "50";
            }
            if (pType == ConfigurationStatus.LotteryType.MXYLQQFFC)
            {
                return "61";
            }
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.MXYLHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLLD2FC)
            {
                str = "LD2SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLTX30M)
            {
                str = "TX30SSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.MXYLQQFFC)
            {
                str = "QQ60SSC";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("梦想娱乐");
        }

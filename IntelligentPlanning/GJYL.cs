namespace IntelligentPlanning
{
    ...
    public class GJYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.GJFFC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.GJ5FC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.GJTX60M)
            {
                return "67";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.GJOZBWC)
            {
                return "20051";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.GJFF11X5)
            {
                return "60";
            }
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("公爵娱乐");
        }

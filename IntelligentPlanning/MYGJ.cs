namespace IntelligentPlanning
{
    ...
    public class MYGJ : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.MYOZBWC)
            {
                return "20051";
            }
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            if (webVerifyCode != "")
            {
                ...
                string pData = string.Format("u_g=0&user_name={0}&password={1}&g_code={1}&valid_code={2}", pID, str5, webVerifyCode);
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("美娱");
        }

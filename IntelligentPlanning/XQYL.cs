namespace IntelligentPlanning
{
    ...
    public class XQYL : PTBase
    {
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYLFFC)
            {
                return "min1";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYL3FC)
            {
                return "min3";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYL5FC)
            {
                return "min5";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYLHGSSC)
            {
                return "hgssc";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYLDJSSC)
            {
                return "djssc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYLSE15F)
            {
                return "seoul90";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYLNY15C)
            {
                return "nylotto";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYLQQFFC)
            {
                return "qqffc";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYLBDFFC)
            {
                return "baiduffc";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYLWBFFC)
            {
                return "weiboffc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYL11X5)
            {
                return "yc11x5";
            }
            if (pType == ConfigurationStatus.LotteryType.XQYLJS11X5)
            {
                return "jis11x5";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.XQYLJSPK10)
            {
                return "jispk10";
            }
        ...
        public bool InputWeb(string pID, string pW, ref string pHint)
        {
            ...
            if (webVerifyCode != "")
            {
                ...
                string pUrl = this.GetLine() + "/api/sf-login";
                string pResponsetext = "";
                string str5 = HttpUtility.UrlEncode(pW);
                string pData = $"username={pID}&password={str5}&googleKey=&securityCode={webVerifyCode}";

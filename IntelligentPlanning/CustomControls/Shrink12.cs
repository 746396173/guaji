namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink12 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            base.Load += new EventHandler(this.Shrink12_Load);
        ...
        private void Shrink12_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

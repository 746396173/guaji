namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink9 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Grp_Main.Size = new Size(0x203, 80);
            ...
            base.Name = "Shrink9";
            base.Size = new Size(0x203, 80);
            base.Load += new EventHandler(this.Shrink9_Load);
        ...
        private void Shrink9_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select1,
                this.Ckb_UnSelect1,

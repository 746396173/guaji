namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink8 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            base.Load += new EventHandler(this.Shrink8_Load);
        ...
        private void Shrink8_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

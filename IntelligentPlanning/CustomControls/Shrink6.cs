namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink6 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            base.Load += new EventHandler(this.Shrink6_Load);
        ...
        private void Shrink6_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

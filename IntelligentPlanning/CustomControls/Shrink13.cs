namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink13 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            base.Load += new EventHandler(this.Shrink13_Load);
        ...
        private void Shrink13_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

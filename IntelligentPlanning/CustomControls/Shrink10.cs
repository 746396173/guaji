namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink10 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Ckb_UnSelect.Location = new Point(0xcf, 0x9a);
            ...
            this.Ckb_Select.Location = new Point(0xb5, 0x9a);
            ...
            base.Name = "Shrink10";
            base.Size = new Size(240, 0xb9);
            base.Load += new EventHandler(this.Shrink10_Load);
        ...
        private void Shrink10_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

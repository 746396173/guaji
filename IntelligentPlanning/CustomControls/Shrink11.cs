namespace IntelligentPlanning.CustomControls
{
    ...
    public class Shrink11 : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Ckb_UnSelect.Location = new Point(0xce, 0x13);
            ...
            this.Ckb_Select.Location = new Point(180, 0x13);
            ...
            this.Grp_Main.Size = new Size(240, 0x37);
            this.Grp_Main.TabIndex = 0xa3;
            this.Grp_Main.TabStop = false;
            this.Grp_Main.Text = "类型排除";
            ...
            base.Name = "Shrink11";
            base.Size = new Size(240, 0x37);
            base.Load += new EventHandler(this.Shrink11_Load);
        ...
        private void Shrink11_Load(object sender, EventArgs e)
        {
            List<CheckBox> list = new List<CheckBox> {
                this.Ckb_Select,
                this.Ckb_UnSelect

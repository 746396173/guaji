namespace IntelligentPlanning.CustomControls
{
    ...
    public class FNDMLHLine : UserControl
    {
        ...
        private RadioButton Rdb_Multiple;
        ...
        private void FNDMLHLine_Load(object sender, EventArgs e)
        {
        ...
        public ConfigurationStatus.FNDMLH GetControlValue(ref string pError)
        {
            ConfigurationStatus.FNBase pInfo = new ConfigurationStatus.FNDMLH();
            this.BT_Time.GetControlValue(ref pInfo);
            ConfigurationStatus.FNDMLH fndmlh = (ConfigurationStatus.FNDMLH) pInfo;
            fndmlh.PlayType = this.Cbb_PlayType.Text;
            fndmlh.PlayName = this.Cbb_PlayName.Text;
            fndmlh.Unit = this.GetUnit();
            fndmlh.BetsJKSelect = this.Ckb_BetsJK.Checked;
            fndmlh.BetsJKValue = this.Txt_BetsJK.Text;
            if (fndmlh.BetsJKSelect && (fndmlh.BetsJKValue == ""))
            {
                pError = "至少要输入一个监控形态！";
                this.Txt_BetsJK.Focus();
                return null;
            }
            if (!CommFunc.CheckStringIsRange(fndmlh.BetsJKValue, "01"))
            {
                pError = "监控形态只能输入0或1！";
                this.Txt_BetsJK.Focus();
                return null;
            }
            fndmlh.BetsJKMode = this.GetJKMode();
            fndmlh.RXZJ = this.Txt_RXZJ.Text;
            fndmlh.RXWZList = this.GetRXWZList();
            if (CommFunc.CheckPlayIsRXDS(this.Play) && (fndmlh.RXWZList.Count < this.PlayInfo.IndexList.Count))
            {
                pError = $"【{this.Play}】至少要选择{this.PlayInfo.IndexList.Count}个位置！";
            }
            fndmlh.Mode = this.GetMode();
            fndmlh.ModeExpect = Convert.ToInt32(this.Nm_ModeExpect.Value);
            fndmlh.FBInfo = this.GetFBType();
            fndmlh.IsBetsZJ = this.Rdb_CodeType1.Checked;
            fndmlh.BTType = this.GetTimesType();
            fndmlh.BTPlanList = CommFunc.SplitString(this.Txt_BTPlan.Text.Replace("，", ","), ",", -1);
            if (this.Rdb_BTPlan.Checked && (fndmlh.BTPlanList.Count == 0))
            {
                pError = "至少要输入一个直线倍投！";
                this.Txt_BTPlan.Focus();
                return null;
            }
            foreach (string str in fndmlh.BTPlanList)
            {
            ...
            fndmlh.BTFNName = this.Cbb_BTFN.Text;
            fndmlh.VisibleMore = this.IsMore;
            fndmlh.DMLHSingle = this.Rdb_Single.Checked;
            fndmlh.DMLHValue = CommFunc.ReplaceText(this.Txt_DMLH.Text, this.PlayInfo, fndmlh.DMLHSingle);
            if (!fndmlh.DMLHSingle)
            {
                fndmlh.DMLHValue = fndmlh.DMLHValue.Replace("\n", "|");
            }
            if (fndmlh.DMLHValue == "")
            {
                pError = "请输入投注的号码！";
            ...
            if (fndmlh.BetsJKSelect && fndmlh.DMLHValue.Contains("|"))
            {
                pError = "启动监控形态后只能支持一组号码！";
                this.Txt_DMLH.Focus();
                return null;
            }
            fndmlh.ZSBetsSelect1 = this.Ckb_MN1.Checked;
            fndmlh.ZSBetsSelect2 = this.Ckb_MN3.Checked;
            fndmlh.MNBetsSelect1 = this.Ckb_MN2.Checked;
            fndmlh.MNBetsSelect2 = this.Ckb_MN4.Checked;
            fndmlh.ZSBetsMoney1 = this.Txt_MN1.Text;
            fndmlh.ZSBetsMoney2 = this.Txt_MN3.Text;
            fndmlh.MNBetsMoney1 = this.Txt_MN2.Text;
            fndmlh.MNBetsMoney2 = this.Txt_MN4.Text;
            ...
            fndmlh.YLStopSelect = this.Ckb_YLStopBets.Checked;
            fndmlh.KSStopSelect = this.Ckb_KSStopBets.Checked;
            fndmlh.YLStopMoney = this.Txt_YLStopBets.Text;
            fndmlh.KSStopMoney = this.Txt_KSStopBets.Text;
            return fndmlh;
        }
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager manager = new ComponentResourceManager(typeof(FNDMLHLine));
            ...
            this.Txt_DMLH = new RichTextBox();
            this.Lbl_NumberCount = new Label();
            this.Rdb_Single = new RadioButton();
            this.Rdb_Multiple = new RadioButton();
            ...
            this.Lbl_Random.Location = new Point(3, 30);
            ...
            this.Ckb_BTCount.TabIndex = 0x155;
            ...
            this.Lbl_ModeExpect.TabIndex = 0x14b;
            ...
            this.Nm_ModeExpect.TabIndex = 330;
            int[] bits = new int[4];
            bits[0] = 2;
            ...
            this.Txt_DMLH.Location = new Point(6, 0x39);
            this.Txt_DMLH.Name = "Txt_DMLH";
            this.Txt_DMLH.ScrollBars = RichTextBoxScrollBars.Vertical;
            this.Txt_DMLH.Size = new Size(320, 0xea);
            this.Txt_DMLH.TabIndex = 0x13f;
            this.Txt_DMLH.Text = "";
            this.Txt_DMLH.TextChanged += new EventHandler(this.Txt_DMLH_TextChanged);
            this.Lbl_NumberCount.AutoSize = true;
            this.Lbl_NumberCount.Location = new Point(0x4a, 30);
            this.Lbl_NumberCount.Name = "Lbl_NumberCount";
            this.Lbl_NumberCount.Size = new Size(0x16, 0x11);
            this.Lbl_NumberCount.TabIndex = 320;
            this.Lbl_NumberCount.Text = "00";
            this.Rdb_Single.AutoSize = true;
            this.Rdb_Single.Checked = true;
            this.Rdb_Single.Location = new Point(0xde, 0x1c);
            this.Rdb_Single.Name = "Rdb_Single";
            this.Rdb_Single.Size = new Size(50, 0x15);
            this.Rdb_Single.TabIndex = 0x141;
            this.Rdb_Single.TabStop = true;
            this.Rdb_Single.Text = "单组";
            this.Rdb_Single.UseVisualStyleBackColor = true;
            this.Rdb_Multiple.AutoSize = true;
            this.Rdb_Multiple.Location = new Point(0x114, 0x1c);
            this.Rdb_Multiple.Name = "Rdb_Multiple";
            this.Rdb_Multiple.Size = new Size(50, 0x15);
            this.Rdb_Multiple.TabIndex = 0x142;
            this.Rdb_Multiple.Text = "多组";
            ...
            this.Ckb_EditJK.TabIndex = 0x155;
            ...
            base.Controls.Add(this.Rdb_Multiple);
            base.Controls.Add(this.Rdb_Single);
            base.Controls.Add(this.Lbl_NumberCount);
            base.Controls.Add(this.Txt_DMLH);
            ...
            base.Controls.Add(this.Lbl_Random);
            base.Controls.Add(this.Lbl_Name);
            this.Font = new Font("微软雅黑", 9f);
            base.Margin = new Padding(3, 4, 3, 4);
            base.Name = "FNDMLHLine";
            base.Size = new Size(0x20d, 0x2ad);
            base.Load += new EventHandler(this.FNDMLHLine_Load);
        ...
        {
            string pErrorHint = "";
            List<string> pCodeList = CommFunc.FilterNumber(CommFunc.ReplaceText(this.Txt_DMLH.Text, this.PlayInfo, true), this.PlayInfo.CodeCount, this.PlayInfo.Play, ref pErrorHint);
        ...
        public void SetControlValue(ConfigurationStatus.FNBase pInfo)
        {
            ...
            this.Txt_RXZJ.Text = fndmlh.RXZJ;
            this.SetRXWZList(fndmlh.RXWZList);
            ...
            this.Rdb_Single.Checked = fndmlh.DMLHSingle;
            this.Rdb_Multiple.Checked = !fndmlh.DMLHSingle;
            this.Txt_DMLH.Text = fndmlh.DMLHValue.Replace("|", "\r\n");

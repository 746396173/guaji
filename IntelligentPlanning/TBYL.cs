namespace IntelligentPlanning
{
    ...
    public class TBYL : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.TBYLQQFFC)
            {
                return "7";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLMG15C)
            {
                return "25";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLSE15C)
            {
                return "26";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLNY15C)
            {
                return "28";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLXDLSSC)
            {
                return "29";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLNHGSSC)
            {
                return "30";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLNDJSSC)
            {
                return "31";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYFLP15C)
            {
                return "33";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLJND35C)
            {
                return "42";
            }
            if (pType == ConfigurationStatus.LotteryType.TBYLJND5FC)
            {
                return "43";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.TBYLJS11X5)
            {
                return "120";
            }
        ...
        {
            string pReferer = "";
            string pUrl = $"{this.GetVRLine()}/Account/LoginValidate?version=1.0&id=TBYL&data={pVRData}";
            string pResponsetext = "";
            HttpHelper.GetResponse(ref pResponsetext, pUrl, "GET", string.Empty, pReferer, 0x2710, "UTF-8", true);
        ...
        public bool LoginWeb()
        {
            ...
            return pResponsetext.Contains("天博");
        }

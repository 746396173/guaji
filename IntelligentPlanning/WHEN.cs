namespace IntelligentPlanning
{
    ...
    public class WHEN : PTBase
    {
        ...
        {
            string str = pExpect;
            if (((((pType != ConfigurationStatus.LotteryType.WHENHS15F) && (pType != ConfigurationStatus.LotteryType.WHENFS15F)) && ((pType != ConfigurationStatus.LotteryType.WHENXDL15F) && (pType != ConfigurationStatus.LotteryType.WHENNDJSSC))) && ((pType != ConfigurationStatus.LotteryType.WHENELSSSC) && (pType != ConfigurationStatus.LotteryType.WHEN120MPK10))) && (pType != ConfigurationStatus.LotteryType.WHEN180MPK10))
            {
                return str;
            }
            if (pIsBets)
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.WHEN30M)
            {
                return "t1s30";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENBLS60M)
            {
                return "t1s60";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENHS15F)
            {
                return "t1s90";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENFS15F)
            {
                return "t1s90a";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENXDL15F)
            {
                return "t1s90b";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENNDJSSC)
            {
                return "t1s90c";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENELSSSC)
            {
                return "t1s90d";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENQQFFC)
            {
                return "t1s60a";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENFLP15C)
            {
                return "phssc";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENHGSSC)
            {
                return "hgssc";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENDJSSC)
            {
                return "jpssc";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENXJPSSC)
            {
                return "sgssc";
            }
            if (pType == ConfigurationStatus.LotteryType.WHENYG60M)
            {
                return "ygmcffc";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WHEN11X5)
            {
                return "t2s90";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.WHEN120MPK10)
            {
                return "t6s120";
            }
            if (pType == ConfigurationStatus.LotteryType.WHEN180MPK10)
            {
                str = "t6s180";
            }
            return str;

namespace IntelligentPlanning
{
    ...
    public class M5CP : PTBase
    {
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.M5FFC)
            {
                return "37";
            }
            if (pType == ConfigurationStatus.LotteryType.M53FC)
            {
                return "35";
            }
            if (pType == ConfigurationStatus.LotteryType.M55FC)
            {
                return "36";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.M511X5)
            {
                return "20";
            }
        ...
        public override string GetNumberList1(List<string> pNumberList, string playName, List<int> pRXWZ = null)
        {
            ...
            if (AppInfo.Current.Lottery.Group == ConfigurationStatus.LotteryGroup.GPSSC)
            {
                ...
                {
                    str = str + this.GetRXWZString1(pRXWZ, playName);
                }
                return str;
            }
        ...
        public override string GetPTHint(string pResponseText)
        {
            ...
            str = CommFunc.UniconToString(CommFunc.GetIndexString(pResponseText, "\"message\":\"", "\"", 0));
            if (str == "")
            {
        ...
        public string GetRXWZString1(List<int> pRXWZ, string playName)
        {
            ...
            return $"@{count}_{CommFunc.Join<int>(pRXWZ)}";
        }

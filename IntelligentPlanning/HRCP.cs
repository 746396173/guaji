    ...
    public class HRCP : PTBase
    {
                ...
                foreach (string str3 in fNNumberDic.Keys)
                {
                    ...
                    foreach (string str4 in dictionary2.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            int pTime = (plan.Type == ConfigurationStatus.LotteryType.UCFFC) ? 0x2710 : 0xea60;
                            HttpHelper.GetResponse(ref pResponsetext, betsLine, "POST", str8, pReferer, pTime, "UTF-8", true);
        ...
        public override void CountPrizeDic(string pResponseText)
        {
            ...
            foreach (string str2 in list)
            {
                ...
                string str4 = CommFunc.GetIndexString(str2, "'prize':", "}", str2.IndexOf("point"));
        ...
        public override void GetAccountsMem(ConfigurationStatus.LotteryType pType, ConfigurationStatus.SCAccountData pInfo)
        {
            try
            {
                ...
                string str5 = pResponsetext.Replace("\n", "").Replace("\r", "").Replace("-", "");
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.HRFFC)
            {
                return "15";
            }
            if (pType == ConfigurationStatus.LotteryType.HR2FC)
            {
                return "16";
            }
            if (pType == ConfigurationStatus.LotteryType.HR45C)
            {
                return "45";
            }

namespace IntelligentPlanning
{
    ...
    public class CTX : PTBase
    {
        ...
        {
            string str = pExpect;
            if (pType == ConfigurationStatus.LotteryType.CTXXDLSSC)
            {
                if (pIsBets)
                {
            ...
            if ((((pType == ConfigurationStatus.LotteryType.GD11X5) || (pType == ConfigurationStatus.LotteryType.SD11X5)) || (pType == ConfigurationStatus.LotteryType.SH11X5)) || (pType == ConfigurationStatus.LotteryType.JX11X5))
            {
                if (pIsBets)
                {
                    str = str.Replace("-0", "-");
        ...
        public override string GetBetsLotteryID(ConfigurationStatus.LotteryType pType)
        {
            ...
            if (pType == ConfigurationStatus.LotteryType.CTXHGSSC)
            {
                return "191";
            }
            if (pType == ConfigurationStatus.LotteryType.CTXDLD30M)
            {
                return "46";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CTXXWYFFC)
            {
                return "119";
            }
            if (pType == ConfigurationStatus.LotteryType.CTXSE15F)
            {
                return "205";
            }
            if (pType == ConfigurationStatus.LotteryType.CTXNY15C)
            {
                return "206";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CTXDJSSC)
            {
                return "601";
            }
            if (pType == ConfigurationStatus.LotteryType.CTXXJPSSC)
            {
                return "51";
            }
            if (pType == ConfigurationStatus.LotteryType.CTXLD2FC)
            {
                return "203";
            }
            ...
            if (pType == ConfigurationStatus.LotteryType.CTXPK10)
            {
                str = "204";
            }
            return str;
        ...
        public override string GetPTLotteryName(ConfigurationStatus.LotteryType pType)
        {
            ...
            else if (pType == ConfigurationStatus.LotteryType.CTXXDLSSC)
            {
                str = "TGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXHGSSC)
            {
                str = "HGSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXDLD30M)
            {
                str = "TG30SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CTXXWYFFC)
            {
                str = "ZYFFSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXSE15F)
            {
                str = "SHOUERSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXNY15C)
            {
                str = "NEWYOSSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CTXDJSSC)
            {
                str = "DJSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXXJPSSC)
            {
                str = "XJPSSC";
            }
            else if (pType == ConfigurationStatus.LotteryType.CTXLD2FC)
            {
                str = "LD2SSC";
            }
            ...
            else if (pType == ConfigurationStatus.LotteryType.CTXPK10)
            {
                str = "AKLPK10";
            }
            return str.ToUpper();
